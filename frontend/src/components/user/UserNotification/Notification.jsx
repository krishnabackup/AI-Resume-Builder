              ...
              <div className="flex w-full justify-center gap-2 sm:w-auto sm:justify-start">
                {["all", "unread", "important"].map((tab) => (
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 capitalize ${filter === tab
...
const NotificationCard = ({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`group p-5 rounded-xl border transition-all duration-300 cursor-pointer hover:shadow-lg hover:scale-[1.01] ${notif.isUnread
    ...
    >
      <div className="flex items-start gap-4">
        {/* Icon */}
        <motion.div
          className={`flex-shrink-0 p-3 rounded-xl transition-all duration-300 ${notif.isUnread
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <h3
                className={`font-bold text-sm mb-1 line-clamp-2 transition-colors ${notif.isUnread ? "text-gray-900" : "text-gray-700"
                  }`}
              >
                {notif.title}
              </h3>
