...
const CoverLetterExamples = () => {
  ...
  const filteredExamples = examples.filter((example) => {
    const matchesCategory =
      activeCategory === "All Examples" || example.category === activeCategory;
    const matchesSearch =
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-['Outfit'] selection:bg-blue-100">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl leading-relaxed mx-auto lg:mx-0">
                Don't start from scratch. Browse our library of cover letter
                examples tailored for every industry and career level.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="show"
              className="flex justify-center lg:justify-end hidden sm:flex"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {categories.map((category) => (
              <button
                ...
                className={`px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 border shadow-sm ${
        ...
        <div className="max-w-7xl mx-auto">
          {filteredExamples.length > 0 ? (
            ...
            <div className="text-center py-20 bg-white rounded-[3rem] border border-dashed border-gray-200 shadow-sm">
              ...
              <h3 className="text-2xl font-bold text-[#1a2e52] mb-3">
                No examples found
              </h3>
              <p className="text-gray-500 max-w-md mx-auto">
                We couldn't find any cover letters matching "{searchQuery}". Try
                searching for a different job title.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
                  setActiveCategory("All Examples");
                }}
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="px-6 pb-24 bg-slate-50"
      >
          ...
          <div className="bg-[#1a2e52] rounded-[3rem] p-8 md:p-20 text-center text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-blue-100/80 mb-12 leading-relaxed">
                ...
                perfectly tailored cover letter that highlights your unique
                value proposition.
              </p>
