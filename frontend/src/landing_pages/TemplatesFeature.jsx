...
const TemplatesFeature = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-['Outfit'] overflow-x-hidden">
      ...
      <section
        ref={featRef}
        className="px-4 sm:px-6 lg:px-8 py-10 sm:py-12 bg-white"
      >
        <div
            ...
            {[
              ...
              >
                ...
                <div className="relative flex items-center justify-center w-20 h-20 mx-auto mb-4 transition-transform duration-500 rounded-xl group-hover:-translate-y-3 group-hover:scale-110">
                  {/* BLUE GLOW (RECTANGLE) */}
                  <div className="absolute inset-0 transition-opacity duration-500 opacity-0 rounded-xl bg-blue-500/40 blur-xl group-hover:opacity-100" />

                  {/* ICON HOLDER */}
                  <div className="relative z-10 flex items-center justify-center w-full h-full transition-all duration-500 ease-out bg-blue-100 border border-blue-200 shadow-sm rounded-xl group-hover:bg-blue-600 group-hover:border-blue-600 group-hover:scale-110 group-hover:-translate-y-0 group-hover:rotate-6 group-hover:shadow-lg">
      ...
      <section
        ref={howRef}
        className="px-4 sm:px-6 lg:px-8 py-12 sm:py-14 bg-gray-50"
      >
        <div
          className={`max-w-5xl mx-auto transition-all duration-700 ${
